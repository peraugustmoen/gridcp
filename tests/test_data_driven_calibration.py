...
from gridcp.calibration import (
    ...
    _compute_false_alarm_threshold_from_max_scores,
...
class TestComputeThreshold:
    ...
    def test_multivariate_with_bonferroni(self):
        ...
        th = _compute_false_alarm_threshold_from_max_scores(
            max_scores, 0.06, apply_bonferroni=True
        )
        assert isinstance(th, np.ndarray)
        assert th.shape == (3,)
...
class TestCalibrateThresholdFromData:
    ...
    def test_deterministic_with_same_rng(self):
        ...
        th2 = calibrate_threshold_false_alarm_from_data(
            score=score,
            training_data=data,
            false_alarm_probability=0.05,
            stream_len=30,
...
class TestCalibrateDetectorThresholdFromData:
    ...
    def test_matches_calibrate_threshold_from_data(self):
        ...
        th2 = calibrate_detector_threshold_false_alarm_from_data(
            detector=detector,
            training_data=data,
            false_alarm_probability=0.05,
            stream_len=30,
...
class TestParitySamplesVsMC:
    """calibrate_threshold_false_alarm_from_samples on draw_samples output must equal
    ...
    def test_scalar_parity(self):
        ...
        th_samples = calibrate_threshold_false_alarm_from_samples(
            score=score,
            samples=samples,
            false_alarm_probability=fap,
            parallel=False,
        )
        th_mc = calibrate_threshold_false_alarm(
            score=score,
            false_alarm_probability=fap,
            n_paths=n_paths,
            stream_len=stream_len,
    ...
    def test_parity_with_parallel_strict_equivalence(self):
        ...
        th_from_samples = calibrate_threshold_false_alarm_from_samples(
            score=score,
            samples=samples,
            false_alarm_probability=fap,
            parallel=False,
        )
        th_mc_strict = calibrate_threshold_false_alarm(
            score=score,
            false_alarm_probability=fap,
            n_paths=n_paths,
            stream_len=stream_len,
...
class TestParallelSerialEquivalence:
    ...
    def test_from_samples_parallel_matches_serial(self):
        ...
        th_parallel = calibrate_threshold_false_alarm_from_samples(
    ...
    def test_from_data_parallel_matches_serial(self):
        ...
        th_parallel = calibrate_threshold_false_alarm_from_data(
            score=score,
            training_data=data,
            false_alarm_probability=0.05,
            stream_len=40,
    ...
    def test_detector_wrapper_parallel_matches_serial(self):
        ...
        th_parallel = calibrate_detector_threshold_false_alarm_from_data(
            detector=detector,
            training_data=data,
            false_alarm_probability=0.05,
            stream_len=30,
...
class TestNJobs:
    ...
    def test_from_samples_n_jobs_1(self):
        ...
        th_j1 = calibrate_threshold_false_alarm_from_samples(
            score=score,
            samples=samples,
            false_alarm_probability=0.05,
            parallel=True,
    ...
    def test_from_samples_n_jobs_2(self):
        ...
        th_j2 = calibrate_threshold_false_alarm_from_samples(
            score=score,
            samples=samples,
            false_alarm_probability=0.05,
            parallel=True,
    ...
    def test_from_data_n_jobs_2(self):
        ...
        th_j2 = calibrate_threshold_false_alarm_from_data(
            score=score,
            training_data=data,
            false_alarm_probability=0.05,
            stream_len=30,
