...
class MultivariateMeanUnknownCovLRState:
    n_samples: int = 0
    sum: np.ndarray = None
...
class MultivariateMeanUnknownCovLR:
    """Multivariate mean-change LR score with unknown covariance."""

    n_features: int

    def init_state(self) -> MultivariateMeanUnknownCovLRState:
        return MultivariateMeanUnknownCovLRState(
    ...
    def update(
        self,
        state: MultivariateMeanUnknownCovLRState,
        x: ArrayLike,
    ...
    def compute_penalised_scores(
        self,
        state: MultivariateMeanUnknownCovLRState,
        grid_states: list[MultivariateMeanUnknownCovLRState],
    ) -> np.ndarray:
